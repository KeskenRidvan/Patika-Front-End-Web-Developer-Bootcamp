...
const StarshipCardSideA = ({ starship, onSelect }) => {
  const infoData = [
    ...
    { icon: "⚖️", label: "Class", value: starship.starship_class },
    {
      icon: "💰",
      label: "Cost",
      value: `₹${Number(starship.cost_in_credits).toLocaleString("tr-TR")}`,
    },
  ...
  return (
    <div
      className="bg-zinc-700 text-white shadow-md rounded-xl p-6 flex flex-col cursor-pointer hover:scale-105 hover:shadow-lg transition-transform duration-300"
      onClick={onSelect}
    >
